...
const LOCAL_DEVELOPMENT_CONFIG = {
  ...
  resolve: {
    alias: {
      ...
      '@globalfishingwatch/react-map-gl': SRC_DIR,
      './mapboxgl': resolve(LIB_DIR, './node_modules/@globalfishingwatch/mapbox-gl/dist/mapbox-gl-dev.js'),
      '../utils/mapboxgl': resolve(LIB_DIR, './node_modules/@globalfishingwatch/mapbox-gl/dist/mapbox-gl-dev.js'),
